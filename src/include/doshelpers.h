...
#define DOS_HELPER_EMUCLIP_HELPER    0x2a
#define DOS_SUBHELPER_EMUCLIP_DRV_CHECK 0
#define DOS_SUBHELPER_EMUCLIP_DRV_INSTALL 1
#define DOS_SUBHELPER_EMUCLIP_DRV_INTERRUPT 2
#define DOS_ERROR_EMUCLIP_ALREADY_INSTALLED 1
#define DOS_ERROR_EMUCLIP_CONFIG_DISABLED 2
#define DOS_ERROR_EMUCLIP_FAILED_TO_INSERT_DRIVER 3
